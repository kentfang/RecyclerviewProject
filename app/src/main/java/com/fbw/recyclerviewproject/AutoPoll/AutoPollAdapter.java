...
//创建RecyclerView滚动控件的适配器类
public class AutoPollAdapter extends RecyclerView.Adapter<AutoPollAdapter.MyHolder> {
    ...
    public void onBindViewHolder(MyHolder holder, int i) {
        ...
        holder.icon.setImageResource(R.mipmap.tx1); //holder对象的icon变量绑定R.mipmap.tx1图片
    }
    //获取记录数
